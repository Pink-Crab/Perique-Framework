 ...
 *
 * Returns Middleware which is a valid class, but doenst implement the middleware interface.
 *
 * @since 2.0.0
...
class With_Invalid_Class_Middleware implements Module {
